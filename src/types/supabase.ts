    ...
    Tables: {
      ...
      triage_leads: {
        Row: {
          ...
          sla_canal: string | null;
          kit_digital_prev: string | null;
          current_state: string | null;
          notes: string | null;
          last_interaction_at: string | null;
          call_missed_count: number | null;
        };
        Insert: {
          id?: string;
          created_at?: string | null;
